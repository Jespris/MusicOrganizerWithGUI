...
public class AddSoundClipCommand extends Command {
    ...
    private final Album selectedAlbum;  // the initial album to where the sound clips are added
    private final ArrayList<SoundClip> soundClips;  // clips to be added
    private final ArrayList<SoundClip> addedClips;  // clips that are actually added,
    ...
    public AddSoundClipCommand(final Album selectedAlbum, final ArrayList<SoundClip> soundClips, final MusicOrganizerWindow view){
    ...
    private boolean invariant() {
        return this.selectedAlbum != null && this.soundClips != null && this.view != null;
    }
